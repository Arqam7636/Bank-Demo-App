...
const account3 = {
  owner: 'Christina Sangou',
  movements: [5000, 3600, -170, -700, -3500, -1000, 11500, -40],
  interestRate: 1.1,
  pin: 3333,
...
/*
// Checking if a number is even using Remainder Operator

const isEven = n => n % 2 === 0;

console.log(isEven(6));
console.log(isEven(16));
console.log(isEven(246));
...
// General Function to calculate the difference of days between any two given dates
